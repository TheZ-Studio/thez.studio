    ...
    >
      <div className="container mx-auto px-6 flex justify-between items-center">
        ...
        <a href="#" className="flex items-center gap-2 group">
          <div className="relative w-10 h-10 flex items-center justify-center border-2 border-studio-accent rounded-sm transform group-hover:rotate-45 transition-transform duration-500">
             <span className="text-2xl font-bold text-studio-accent group-hover:-rotate-45 transition-transform duration-500">Z</span>
          </div>
          <span className="text-xl font-bold tracking-tight text-white group-hover:text-studio-accent transition-colors">
