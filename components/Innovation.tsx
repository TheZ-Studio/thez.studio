      ...
      <div className="bg-gradient-to-r from-studio-card to-[#004d40] rounded-2xl p-10 md:p-16 border border-studio-accent/30 relative overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-center gap-8">
          <div className="md:w-1/3 flex justify-center md:justify-start">
            <div className="w-24 h-24 bg-studio-bg rounded-full flex items-center justify-center border-4 border-studio-accent shadow-[0_0_30px_rgba(0,230,118,0.4)] overflow-hidden">
              <img src="/logos/studio-logo.png" alt="TheZ Studio" className="w-full h-full object-cover" />
            </div>
          </div>
